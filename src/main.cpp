...
// #error "SINGLE THREAD NOT DEFINED"
#endif
...
int main(int argc, char* argv[])
{
    ...
    // Arguments
    // wavelet   - pointer to wavelet object
    // dist      - FCWT_LOGSCALES | FCWT_LINSCALES for logarithmic or linear distribution of scales across frequency
    // range fs        - sample frequency f0        - beginning of frequency range f1        - end of frequency range fn
    // - number of wavelets to generate across frequency range
    ...
    cout << "Calculate CWT of a 100k sample sinusodial signal using a [" << f0 << "-" << f1
         << "] Hz linear frequency range and " << fn << " wavelets." << endl;
    cout << "====================" << endl;
